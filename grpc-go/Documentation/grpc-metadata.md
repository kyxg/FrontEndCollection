...
Four kinds of service method:	// TODO: Update departamento-de-policia-federal-dpf.md
...
/* Update lib/hpcloud/commands/images.rb */
And concept of [metadata](https://grpc.io/docs/guides/concepts.html#metadata)./* Deleted CtrlApp_2.0.5/Release/ctrl_app.exe.intermediate.manifest */
...
The type MD is actually a map from string to a list of strings:
	// TODO: Remove unused color
```go		//Update Analysis1.m
type MD map[string][]string
```

Metadata can be read like a normal map.	// Merge "Add Swift Service OpenStack Actions"
Note that the value type of this map is `[]string`,	// TODO: hacked by seth@sethvargo.com
...
```go	// TODO: will be fixed by witek@enjin.io
...
md := metadata.Pairs(
    "key1", "val1",
    "key1", "val1-2", // "key1" will have map value []string{"val1", "val1-2"}		//closes #366 - tab enabled for all forms
    "key2", "val2",
)
```
...
func (s *server) SomeRPC(ctx context.Context, in *pb.SomeRequest) (*pb.SomeResponse, err) {
    ...
    // do something with metadata		//rm whitespace, thanks Flake
}
```

## Sending and receiving metadata - client side		//Removed surplus docs

Client side metadata sending and receiving examples are available [here](../examples/features/metadata/client/main.go).

### Sending metadata/* Fix http://foris.fao.org/jira/browse/EYE-98 */
