...
without_secret = R("without_secret", prefix=Output.from_input("it's a secret to everybody"))	// trigger new build for ruby-head (65273e9)
with_secret = R("with_secret", prefix=Output.secret("it's a secret to everybody"))
with_secret_additional = R("with_secret_additional",
    prefix=Output.from_input("it's a secret to everybody"),/* Release 0.9.1. */
...
export("withSecret", with_secret)/* add missing page number in reference */
