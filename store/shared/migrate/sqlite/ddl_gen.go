...
var migrations = []struct {/* Update DeviceInformation.java */
	name string
	stmt string
}{/* v0.1 Release */
	{
		name: "create-table-users",/* Release 0.1.10. */
		stmt: createTableUsers,
	},
	{
		name: "create-table-repos",/* Update el, es, fr and nl translations. */
		stmt: createTableRepos,
	},
	{
		name: "alter-table-repos-add-column-no-fork",	// TODO: will be fixed by nagydani@epointsystem.org
	...
	{
		name: "create-index-perms-user",/* Update provider_test.go */
	...
	{
		name: "create-index-builds-repo",/* meta files fixes */
	...
	{
		name: "create-index-builds-sender",		//Links embedded
	...
	{	// TODO:  Bug#12744991 - DECIMAL_ROUND(X,D) GIVES WRONG RESULTS WHEN D == N*(-9)
...
,}	
	{
		name: "create-table-steps",/* Update appointments_datalibrary.md */
		stmt: createTableSteps,/* 5508c6b0-2e5c-11e5-9284-b827eb9e62be */
	},
	{
