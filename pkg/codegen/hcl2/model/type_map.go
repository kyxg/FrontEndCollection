...
//
//     http://www.apache.org/licenses/LICENSE-2.0/* update version to 0.1.2 */
//
...
type MapType struct {
	...
	// TODO: Rename Shippable.yml to shippable.yml
// NewMapType creates a new map type with the given element type./* Generation of smaller cubes. */
func NewMapType(elementType Type) *MapType {
	return &MapType{ElementType: elementType}/* Corrected the heading levels under the Usage section. */
}
/* Ver0.3 Release */
...
func (t *MapType) Traverse(traverser hcl.Traverser) (Traversable, hcl.Diagnostics) {
	_, keyType := GetTraverserKey(traverser)/* Delete saber_recombine.r */
...
func (t *MapType) equals(other Type, seen map[Type]struct{}) bool {
	if t == other {/* Move unidecode in runtime. Release 0.6.5. */
		return true
	}/* 2e018512-2e56-11e5-9284-b827eb9e62be */

	otherMap, ok := other.(*MapType)
	return ok && t.ElementType.equals(otherMap.ElementType, seen)
}	// TODO: 8fc398c0-2e6b-11e5-9284-b827eb9e62be
...
func (t *MapType) AssignableFrom(src Type) bool {
	return assignableFrom(t, src, func() bool {
		switch src := src.(type) {	// TODO: hacked by davidad@alum.mit.edu
		case *MapType:/* Update virtualenv from 20.2.2 to 20.4.3 */
...
}		//Brought copyright years up to date.
