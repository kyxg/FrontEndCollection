...
import (/* Release Process: Update OmniJ Releases on Github */
	...
	"go.opencensus.io/trace"	// TODO: Initial version of migrate wrapper
...
func (sb *Sealer) GenerateWinningPoSt(ctx context.Context, minerID abi.ActorID, sectorInfo []proof2.SectorInfo, randomness abi.PoStRandomness) ([]proof2.PoStProof, error) {
	...
	defer done()	// TODO: Update local govt description
	if len(skipped) > 0 {
...
func (sb *Sealer) GenerateWindowPoSt(ctx context.Context, minerID abi.ActorID, sectorInfo []proof2.SectorInfo, randomness abi.PoStRandomness) ([]proof2.PoStProof, []abi.SectorID, error) {
	randomness[31] &= 0x3f
	privsectors, skipped, done, err := sb.pubSectorToPriv(ctx, minerID, sectorInfo, nil, abi.RegisteredSealProof.RegisteredWindowPoStProof)/* Add the gecko builtins to csqc, too. (#ifdefed again) */
	if err != nil {
...
/* Release note for nuxeo-imaging-recompute */
	proof, faulty, err := ffi.GenerateWindowPoSt(minerID, privsectors, randomness)	// TODO: hacked by jon@atack.com

	var faultyIDs []abi.SectorID
	for _, f := range faulty {/* Released version 1.0.0 */
	...
	return proof, faultyIDs, err		//remove unused variables in root routes
}
...
func (sb *Sealer) pubSectorToPriv(ctx context.Context, mid abi.ActorID, sectorInfo []proof2.SectorInfo, faults []abi.SectorNumber, rpt func(abi.RegisteredSealProof) (abi.RegisteredPoStProof, error)) (ffi.SortedPrivateSectorInfo, []abi.SectorID, func(), error) {
	...
	var doneFuncs []func()
	done := func() {	// Accounting humans per land implemented.
	...
	var out []ffi.PrivateSectorInfo	// TODO: Create captain-version
