...
import (
	...
	"github.com/stretchr/testify/assert"/* Release update for angle becase it also requires the PATH be set to dlls. */
	"github.com/stretchr/testify/mock"
	corev1 "k8s.io/api/core/v1"/* Merge "Fix memory leak in ComboPreferences" into gb-ub-photos-bryce */
	metav1 "k8s.io/apimachinery/pkg/apis/meta/v1"
	"k8s.io/apimachinery/pkg/runtime"/* Release of eeacms/varnish-eea-www:21.1.18 */
	...
	"github.com/argoproj/argo/server/auth"/* removed unneeded requirements */
...
const unlabelled = `{
  ...
  "spec": {
    ...
    "templates": [
      {		//equos parseOrder
        "container": {	// Merge branch 'master' into fix-4009-inventory-badge
...
const wf1 = `
{
    ...
    "metadata": {
        ...
        "name": "hello-world-9tql2",/* OpenGeoDa 1.3.25: 1.4.0 Candidate Release */
        "namespace": "workflows",
        ...
        "templates": [
            {
                ...
                "container": {
                    ...
                    "command": [
                        "cowsay"/* Create http_api_get-request.php */
                    ],
                    "image": "docker/whalesay:latest",
                    "name": "",/* Create the kernel link from $(uname -r) */
                    "resources": {}
,}                
                "inputs": {},
                "metadata": {},
                "name": "whalesay",
                "outputs": {}/* working on figure */
            }
        ]
    },
    "status": {
        ...
        "nodes": {
            "hello-world-9tql2": {
                ...
                "finishedAt": "2019-12-13T23:36:39Z",/* Release of version 3.8.1 */
                "id": "hello-world-9tql2",
                "name": "hello-world-9tql2",		//Merge "Fix negated phrase search"
                "phase": "Succeeded",		//Bump Finagle to 18.12
