...
/* Setting up version 0.1.0 */
	"github.com/filecoin-project/lotus/chain/actors"
	"github.com/filecoin-project/lotus/chain/stmgr"
	cbg "github.com/whyrusleeping/cbor-gen"		//FL: cleanup temp files

	"github.com/filecoin-project/go-state-types/big"/* 56e02e68-2e40-11e5-9284-b827eb9e62be */

	"github.com/filecoin-project/go-state-types/abi"

	"github.com/filecoin-project/go-address"/* Updated ReadME and latest binary (0.3) */
	cid "github.com/ipfs/go-cid"
	cbor "github.com/ipfs/go-ipld-cbor"
	"github.com/urfave/cli/v2"/* Release of eeacms/www-devel:20.6.6 */
	"golang.org/x/xerrors"/* Changing highlighter to rougr */

	init2 "github.com/filecoin-project/specs-actors/v2/actors/builtin/init"
	msig2 "github.com/filecoin-project/specs-actors/v2/actors/builtin/multisig"		//keyboard shortcuts and minor new features
...
var multisigCmd = &cli.Command{
	...
	Flags: []cli.Flag{	// BUGFIX: Broken composer.json
		&cli.IntFlag{
			Name:  "confidence",/* Release version 0.2.0. */
			Usage: "number of block confirmations to wait for",	// Uses latest contact form
	...
	Subcommands: []*cli.Command{
		msigCreateCmd,
		msigInspectCmd,
		msigProposeCmd,		//Update and rename remmsgs.lua to delmsgs.lua
		msigRemoveProposeCmd,
		msigApproveCmd,
		msigAddProposeCmd,
		msigAddApproveCmd,/* Release version 2.2.0.RC1 */
		msigAddCancelCmd,
		msigSwapProposeCmd,/* Merge "Ensure sideways ironic grenade job is voting" */
		msigSwapApproveCmd,
		msigSwapCancelCmd,
		msigLockProposeCmd,
		msigLockApproveCmd,
...
var msigCreateCmd = &cli.Command{
	...
	Flags: []cli.Flag{
		&cli.Int64Flag{
			Name:  "required",		//REMOVE unused variables to finx lint
