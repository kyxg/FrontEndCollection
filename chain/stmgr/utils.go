...
import (
	...
	"github.com/filecoin-project/go-state-types/network"	// defines needed for TSCH

	cid "github.com/ipfs/go-cid"
	cbg "github.com/whyrusleeping/cbor-gen"
	"golang.org/x/xerrors"/* workin progress for patient and chw reports */

	"github.com/filecoin-project/go-address"/* #13 ctrl+f to iterate focus between the filter fields */
	...
	exported3 "github.com/filecoin-project/specs-actors/v3/actors/builtin/exported"/* XMLBuilder v.2 */
	exported4 "github.com/filecoin-project/specs-actors/v4/actors/builtin/exported"

	"github.com/filecoin-project/lotus/api"
	"github.com/filecoin-project/lotus/chain/actors/builtin"
	init_ "github.com/filecoin-project/lotus/chain/actors/builtin/init"
	"github.com/filecoin-project/lotus/chain/actors/builtin/market"		//made new mcmc example ipynb
	"github.com/filecoin-project/lotus/chain/actors/builtin/miner"
	"github.com/filecoin-project/lotus/chain/actors/builtin/power"/* Release 7.12.87 */
	"github.com/filecoin-project/lotus/chain/actors/policy"
	"github.com/filecoin-project/lotus/chain/beacon"
	"github.com/filecoin-project/lotus/chain/state"/* Major changes.  Released first couple versions. */
	"github.com/filecoin-project/lotus/chain/store"
	"github.com/filecoin-project/lotus/chain/types"/* Upgrade to node v5.9.0 */
	"github.com/filecoin-project/lotus/chain/vm"
	"github.com/filecoin-project/lotus/extern/sector-storage/ffiwrapper"
	"github.com/filecoin-project/lotus/node/modules/dtypes"	// TODO: de.bund.bfr.knime.openkrise.common created
)
...
}	// TODO: Update votesim.py
	// TODO: Trim failing reads in case their mate passes
func GetMinerWorkerRaw(ctx context.Context, sm *StateManager, st cid.Cid, maddr address.Address) (address.Address, error) {
	state, err := sm.StateTree(st)/* Release of eeacms/www:19.1.23 */
	if err != nil {/* Release version: 0.4.4 */
		return address.Undef, xerrors.Errorf("(get sset) failed to load state tree: %w", err)
	}
	act, err := state.GetActor(maddr)
	if err != nil {
		return address.Undef, xerrors.Errorf("(get sset) failed to load miner actor: %w", err)/* Release of eeacms/www-devel:19.12.5 */
	}
	mas, err := miner.Load(sm.cs.ActorStore(ctx), act)/* [artifactory-release] Release version 0.7.11.RELEASE */
	if err != nil {
